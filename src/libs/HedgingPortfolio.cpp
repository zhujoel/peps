...
HedgingPortfolio::HedgingPortfolio(double prix, PnlVect* delta, PnlVect* share_values, double rd, double val_liquidative_initiale)
{
...
void HedgingPortfolio::rebalancing(double t, PnlVect* delta, PnlVect* share_values)
{
...
double HedgingPortfolio::get_portfolio_value(double t, PnlVect* share_values)
{
    return exp(this->rd_*(t-this->last_rebalancing_t_))*this->V1_ + pnl_vect_scalar_prod(this->delta_, share_values);
}

double HedgingPortfolio::get_tracking_error(double t, double prix, PnlVect* share_values)
{
    return this->get_portfolio_value(t, share_values) - prix;
}

double HedgingPortfolio::get_valeur_liquidative(double t, PnlVect* share_values)
{
    return exp(this->rd_*(t-this->last_rebalancing_t_))*this->V2_ + pnl_vect_scalar_prod(this->delta_, share_values);
}

double HedgingPortfolio::get_FinalPnL(double t, double payoff, PnlVect* share_values)
{
