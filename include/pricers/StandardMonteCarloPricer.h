...
class StandardMonteCarloPricer : public IPricer{
    public:
        ...
        void price_and_delta(const PnlMat * const past, double t, const PnlMat * const sigma, double &prix, double &price_std_dev, PnlVect * const delta, PnlVect * const delta_std_dev);
        void price(const PnlMat * const past, double t, const PnlMat * const sigma, double &prix, double &price_std_dev);
