...
class IPricer{
    public:
        ...
        virtual void price_and_delta(const PnlMat *past, double t, const PnlMat *sigma, double &prix, double &price_std_dev, PnlVect *delta, PnlVect *delta_std_dev) = 0;
        virtual void price(const PnlMat *past, double t, const PnlMat *sigma, double &prix, double &price_std_dev) = 0;
        virtual void add_price(double t, double &prix, double &std_dev) = 0;
        virtual void add_delta(double t, int pastSize, PnlVect *delta, PnlVect *std_dev) = 0;
};