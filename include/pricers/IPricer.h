...
class IPricer{
    public:
        ...
        virtual void price(double t, double &prix, double &std_dev) = 0;
        virtual void delta(double t, int pastSize, PnlVect *delta, PnlVect *std_dev) = 0;
        
        // TODO: ces méthodes ne servent plus, à virer 
        virtual void discount_price(double t, double &prix, double &std_dev) = 0;
        virtual void discount_delta(const PnlMat *past, double t, PnlVect *delta, PnlVect *std_dev) = 0;
};